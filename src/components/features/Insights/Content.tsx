...
const statusStyles = {
  viable: {
    ...
    className: 'bg-green-200 text-green-800 dark:bg-green-900/60 dark:text-green-300',
  },
  needs_adjustment: {
    label: 'Ajuste necessário',
    className: 'bg-amber-200 text-amber-800 dark:bg-amber-900/60 dark:text-amber-300',
  },
  unfeasible: {
    label: 'Meta inviável no prazo',
    className: 'bg-red-200 text-red-800 dark:bg-red-900/60 dark:text-red-300',
  },
};
